...
certTable.controller('certTableController', function certTableController($scope, $http) {
    ...
    var team = {"team" : [
            ...
            {'name': 'Nicolas Mejia Nino', 'certifications': ['Salesforce Certified Administrator', 'Salesforce Certified OmniStudio Developer', 'Salesforce Certified Platform Developer I'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/mountaineer.png', 'badges': '31', 'point': '26,900', 'trails': '1'},
            {'name': 'Jose Luis Blasco Ortiz', 'certifications': ['Salesforce Certified Administrator', 'Salesforce Certified Industries CPQ Developer', 'Salesforce Certified OmniStudio Developer', 'Salesforce Certified Platform Developer I'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/expeditioner.png', 'badges': '101', 'point': '47,550', 'trails': '5'},
            {'name': 'Andre Rodrigues', 'certifications': ['Salesforce Certified OmniStudio Developer', 'Salesforce Certified Associate'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/ranger.png', 'badges': '162', 'point': '112,150', 'trails': '20'},
            {'name': 'Giovanni Falco', 'certifications': ['Salesforce Certified Administrator', 'Salesforce Certified Industries CPQ Developer', 'Salesforce Certified Platform Developer I'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/expeditioner.png', 'badges': '53', 'point': '49,202', 'trails': '1'},
            {'name': 'Javier Campos', 'certifications': [], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/mountaineer.png', 'badges': '46', 'point': '33,325', 'trails': '2'},
            {'name': 'Oscarina Gallardo', 'certifications': ['Salesforce Certified Administrator', 'Salesforce Certified Industries CPQ Developer', 'Salesforce Certified OmniStudio Developer', 'Salesforce Certified Platform Developer I'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/expeditioner.png', 'badges': '89', 'point': '76,143', 'trails': '3'},
            {'name': 'Victor Pacheco', 'certifications': [], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/expeditioner.png', 'badges': '63', 'point': '72,725', 'trails': '3'},
            {'name': 'Juan M. Parra I.', 'certifications': ['Salesforce Certified Industries CPQ Developer', 'Salesforce Certified OmniStudio Developer', 'Salesforce Certified Platform Developer I'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/mountaineer.png', 'badges': '40', 'point': '37,150', 'trails': '0'},
            ...
            {'name': 'Yan Silva', 'certifications': [], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/triple-star-ranger.png', 'badges': '559', 'point': '193,900', 'trails': '78'},
            ...
            {'name': 'Jose Ortiz Gomez', 'certifications': [], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/mountaineer.png', 'badges': '62', 'point': '30,900', 'trails': '6'},
            ...
            {'name': 'David Bujan', 'certifications': ['Salesforce Certified Administrator'], 'badges_img': 'https://res.cloudinary.com/trailhead/image/upload/public-trailhead/assets/images/ranks/hiker.png', 'badges': '9', 'point': '2,925', 'trails': '1'}
        ]};
    $scope.team = team;
});
